...
document.querySelectorAll('.js-delivery-option')
 ...
 /*
    ...
    N.B: For this function renderOrderSumma

    prob: we need to update the page one-by-one and later there might be lots of places on the page we need to update
          (for example: when we change the delivery option we also need to change the prices on order summary section)
         there are a lot of things we need to update one-by-one and it's easy to make a mistake or to forget somet 
 */  